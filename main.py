...
from routes import json_export, md_full, md_clean, zip_export, csv_export, excel_export, opml_export, mm_export, xmind_export, pyrus_upload, xmind_procedures, call_pyrus_upload
...
app.include_router(call_pyrus_upload.router)
